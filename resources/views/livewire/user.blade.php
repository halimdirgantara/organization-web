    ...
    @if ($createForm)
        <div
            ...
            <div>
                ...
                <div class="mt-4">
                    <x-inputs.password wire:model="password" label="Kata Sandi"
                    hint="Kosongkan jika ingin menggunakan kata sandi awal (Sekadau$23)" />
                </div>
                <div class="mt-4">
    ...
    @if ($editForm)
        <div
            ...
            <div>
                            ...
                            <label for="dropzone-file"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    @if ($user->profile_photo_url)
                                        <img src="{{ $user->profile_photo_url }}" alt="Logo"
                                            class="mb-3 object-cover w-48 h-48">
                                    @else
                                        <svg aria-hidden="true" class="w-10 h-10 mb-3 text-gray-400" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24"
                                ...
                                <input wire:model.defer="photoProfile" id="dropzone-file" type="file" class="hidden"
                                    accept="image/*" />
                            </label>
                        </div>
                    </div>
                ...
                <div class="mt-4">
                    <x-inputs.password wire:model.defer="password" label="Kata Sandi"
                    hint="Kosongkan jika tidak ingin mengubah kata sandi" />
                </div>
                <div class="mt-4">
                    <input wire:model.defer="user_id" type="hidden" class="hidden" />
